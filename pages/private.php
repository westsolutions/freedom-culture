...
<!--.video-->
        ...
        <div class="video-block video-bg-gr-primary">
            <div class="video-block-content">
              <div class="video-block-title">
                <h3>
                  About the <mark>Event</mark>
                </h3>
              </div>
              <div class="video-content">
                <iframe width="100%" height="100%" src="https://www.youtube.com/embed/hN_q-_nGv4U" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
              </div>
            </div>
        </div>
      </div>
      <div class="col-12 col-md-6">
        <div class="video-block video-bg-primary">
          <div class="video-block-content">
            <div class="video-block-title">
              <h3>
                Sponsorship <mark>Opportunities</mark>
              </h3>
            </div>
            <div class="video-content">
              <iframe width="100%" height="100%" src="https://www.youtube.com/embed/hN_q-_nGv4U" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
 ...
 <section class="event-detail">
   <a href="#" class="event-detail-content">
    Event <mark>Details <i class="fas fa-arrow-right"></i></mark>
   </a>
 </section>
<!-- ask-network-content -->
